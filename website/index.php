				...
				<table class="table-listing">
					...
					<tbody>
						<tr ng-repeat="audio in data track by $index">
							...
							<td>
								<select class="form-control" ng-model="audio.intelligibility">
									<option value="" disabled>Intelligibility</option>
							...
							<td>
								<select class="form-control" ng-model="audio.naturalness">
									<option value="" disabled>Naturalness</option>
									<option value="Poor">Poor</option>
									<option value="Fair">Fair</option>
									<option value="Good">Good</option>
									<option value="Very Good">Very Good</option>
							...
							<td>
								<select class="form-control" ng-model="audio.emotion">
									<option value="" disabled>Emotion</option>
									<option value="Poor">Poor</option>
									<option value="Fair">Fair</option>
									<option value="Good">Good</option>
									<option value="Very Good">Very Good</option>
